    ...
    <div className="relative w-80 h-80 flex items-center justify-center">
      <svg viewBox="0 0 320 320" className="w-full h-full">
        ...
        <g>
          ...
          <text x="80" y="200" textAnchor="middle" className="text-xs fill-current font-medium">
            Buyer
          </text>

          {/* Escrow */}
          <rect x="140" y="140" width="40" height="40" rx="8" className="fill-blue-600">
          ...
          <text x="160" y="210" textAnchor="middle" className="text-xs fill-current font-medium">
            Escrow
          </text>

          {/* Seller */}
          <circle cx="240" cy="160" r="20" className="fill-purple-500">
            <animate attributeName="r" values="18;22;18" dur="3s" repeatCount="indefinite" begin="1s" />
          </circle>
          <text x="240" y="200" textAnchor="middle" className="text-xs fill-current font-medium">
            Seller
          </text>
        </g>

        {/* Animated arrows */}
        <g className="stroke-current text-blue-600" strokeWidth="3" fill="none" markerEnd="url(#arrowhead)">
          <defs>
          ...
          <path d="M185 160 L215 160">
            ...
            <animate attributeName="stroke-dashoffset" values="30;0" dur="2s" repeatCount="indefinite" begin="1s" />
          </path>
        </g>
  ...
  return (
    <div className="relative w-full max-w-md mx-auto p-4">
      <svg viewBox="0 0 400 250" className="w-full h-auto">
        {/* Title */}
        <text x="200" y="30" textAnchor="middle" className="text-sm font-semibold fill-current">
        ...
        <g>
          {[0, 1, 2, 3, 4].map((i) => (
            <g key={i}>
              {/* Validator circle */}
              <circle cx={60 + i * 70} cy="120" r="18" className="fill-blue-600">
                <animate
                  attributeName="fill"
              ...
              {/* Raised hand */}
              <rect x={55 + i * 70} y="100" width="2" height="12" rx="1" className="fill-white">
                <animateTransform
                  attributeName="transform"
                  type="rotate"
                  values={`0 ${56 + i * 70} 106;-20 ${56 + i * 70} 106;0 ${56 + i * 70} 106`}
                  dur="3s"
                  repeatCount="indefinite"
                  begin={`${i * 0.6}s`}
                />
        ...
        <g className="text-xs">
          {["YES", "YES", "NO", "YES", "YES"].map((vote, i) => (
            <text
              ...
              y="170"
              textAnchor="middle"
              className={`font-medium ${vote === "YES" ? "fill-green-600" : "fill-red-600"}`}
            >
              <animate
        ...
        <g>
          {[0, 1, 2, 3, 4].map((i) => (
            <g key={i}>
              <circle cx={60 + i * 70} cy="80" r="4" className="fill-yellow-500">
                <animateTransform
                  attributeName="transform"
                  type="translate"
              ...
              <text x={60 + i * 70} y="85" textAnchor="middle" className="text-xs fill-yellow-600 font-bold">
                <animateTransform
                  attributeName="transform"
                  type="translate"
                  values="0,0;0,-25;0,-50"
        ...
        {/* Progress bar */}
        <rect x="50" y="200" width="300" height="8" rx="4" className="fill-gray-200 dark:fill-gray-700" />
        <rect x="50" y="200" width="210" height="8" rx="4" className="fill-green-500">
          <animate attributeName="width" values="0;210;210" dur="5s" repeatCount="indefinite" />
        </rect>
        <text x="200" y="225" textAnchor="middle" className="text-xs fill-current">
          Consensus: 70% YES
        </text>
      </svg>
    </div>
...
export default function CrailoLanding() {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? "dark" : ""}`}>
      ...
      <header className="sticky top-1 z-40 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between px-4 md:px-6">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <a href="#why-crailo" className="text-sm font-medium hover:text-blue-600 transition-colors relative group">
              Why Crailo
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all group-hover:w-full"></span>
            </a>
            <a href="#validators" className="text-sm font-medium hover:text-blue-600 transition-colors relative group">
              Validators
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all group-hover:w-full"></span>
            </a>
            <a href="#community" className="text-sm font-medium hover:text-blue-600 transition-colors relative group">
              Community
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all group-hover:w-full"></span>
            </a>
          </nav>
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            ...
            >
              <div className="space-y-2">
                ...
                >
                  Escrow-protected. Validator-verified. Scam-free. Experience the future of peer-to-peer marketplace
      ...
      {/* How It Works */}
      <section id="how-it-works" ref={howItWorksRef} className="w-full py-12 md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
          ...
          >
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">How Crailo Works</h2>
          ...
          <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-4 lg:gap-8">
            {[
              ...
              const colorClasses = {
                ...
                purple: "bg-purple-100 dark:bg-purple-900 text-purple-600 border-purple-600",
                yellow: "bg-yellow-100 dark:bg-yellow-900 text-yellow-600 border-yellow-600",
              }
              ...
              return (
                ...
                >
                  <CardHeader className="pb-4 relative z-10">
                    <div
                      className={`w-12 h-12 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform ${colorClasses[step.color as keyof typeof colorClasses]}`}
                    >
      ...
      {/* Why Crailo */}
      <section id="why-crailo" ref={whyCrailoRef} className="w-full py-12 md:py-24 lg:py-32 bg-muted/50">
        <div className="container px-4 md:px-6">
          <div
            className={`flex flex-col items-center justify-center space-y-4 text-center transition-all duration-1000 ${
              whyCrailoInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            }`}
          >
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Why Choose Crailo?</h2>
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            ...
            {[
              ...
              return (
                <div
                  ...
                  style={{
                    transitionDelay: whyCrailoInView ? `${benefit.delay}ms` : "0ms",
                  }}
                >
                  <div
                    className={`w-16 h-16 rounded-full flex items-center justify-center group-hover:shadow-lg group-hover:scale-110 transition-all duration-300 ${colorClasses[benefit.color as keyof typeof colorClasses]}`}
                  >
                    <Icon className="h-8 w-8 group-hover:animate-pulse" />
                  </div>
                  <h3 className="text-xl font-bold group-hover:text-blue-600 transition-colors">{benefit.title}</h3>
      ...
      {/* Validator System */}
      <section id="validators" ref={validatorsRef} className="w-full py-12 md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
            <div
              className={`flex flex-col justify-center space-y-4 transition-all duration-1000 ${
                validatorsInView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"
              }`}
            >
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Validator System</h2>
                <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed">
                  Our community-driven dispute resolution ensures fair outcomes for everyone. Validators vote on
                  disputes with simple Yes/No decisions.
                </p>
              </div>
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    description: "Get a share of platform fees based on your validation activity",
                    delay: 200,
                  },
                  {
                    title: "Reputation System",
                    description: "Build your validator reputation for higher rewards and influence",
                    delay: 400,
                  },
                ].map((item, index) => (
                  <div
                    ...
                    className={`flex items-start space-x-3 transition-all duration-500 ${
                      validatorsInView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-5"
                    }`}
                    style={{
                      transitionDelay: validatorsInView ? `${item.delay + 300}ms` : "0ms",
                    }}
                  >
              ...
              <Card className="w-full max-w-md hover:shadow-xl transition-shadow duration-300">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">"iPhone 13 not as described - screen has scratches"</p>
                  </div>
                  <div className="space-y-2">
      ...
      {/* Case Scenarios */}
      <section ref={scenariosRef} className="w-full py-12 md:py-24 lg:py-32 bg-muted/50">
        <div className="container px-4 md:px-6">
          <div
            className={`flex flex-col items-center justify-center space-y-4 text-center transition-all duration-1000 ${
              scenariosInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            }`}
          >
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">How Different Scenarios Play Out</h2>
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Transparency in action - see exactly what happens in each situation
              </p>
            </div>
          </div>
          <div
          ...
          >
            <Accordion type="single" collapsible className="w-full space-y-4">
              ...
              <AccordionItem value="seller-scams" className="border rounded-lg px-6 hover:shadow-lg transition-shadow">
                <AccordionTrigger className="hover:no-underline">
                  <div className="flex items-center space-x-3">
                ...
                <AccordionContent className="pt-4">
                  <div className="space-y-3">
                    <p className="text-muted-foreground">When a seller doesn't deliver or sends wrong/damaged items:</p>
              ...
              >
                ...
                <AccordionContent className="pt-4">
                  <div className="space-y-3">
                    <p className="text-muted-foreground">When everything goes smoothly and both parties are happy:</p>
      ...
      {/* Testimonials */}
      <section id="community" ref={testimonialsRef} className="w-full py-12 md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
          <div
            className={`flex flex-col items-center justify-center space-y-4 text-center transition-all duration-1000 ${
          ...
          >
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Trusted by Our Community</h2>
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
      ...
      >
        ...
        <div className="container px-4 md:px-6 relative z-10">
          ...
          >
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Ready to Trade Safely?</h2>
              <p className="max-w-[600px] text-blue-100 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Join the Crailo beta and experience the future of secure peer-to-peer trading.
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className="text-xs text-blue-200">Get early access and exclusive rewards. No spam, ever.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        ...
        <p className="text-xs text-muted-foreground sm:ml-auto">© 2024 Crailo. Building the future of safe trading.</p>
