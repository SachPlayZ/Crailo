...
import { Users, CheckCircle, XCircle, ThumbsUp } from "lucide-react";
...
export default function ValidatorSection({
  ...
  const { isValidator, isLoading } = checkValidator(address || "");
  const isUserValidator = Boolean(isValidator);
  ...
  return (
    <>
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
            ...
            >
              ...
              <Button
                ...
                className={`w-fit transition-all duration-200 relative overflow-hidden group ${
                  isUserValidator
      ...
      <ValidatorOnboardingModal
        ...
        isAlreadyValidator={isUserValidator}
      />
    </>
  );
}
