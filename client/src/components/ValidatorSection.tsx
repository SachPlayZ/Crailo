...
import ValidatorOnboardingModal from "./ValidatorOnboardingModal";
                        ...
                        >
                            <div className="space-y-4">
                                ...
                                <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed">
                                    Our community-driven dispute resolution
                                    ensures fair outcomes for everyone.
                                    Validators vote on disputes with simple
                                    Yes/No decisions.
                                </p>
                            </div>
                            ...
                            <Button
                                ...
                                className="w-fit bg-green-600 hover:bg-green-700 hover:scale-105 transition-all duration-200 relative overflow-hidden group"
                            >
                            ...
                            <Card className="w-full max-w-md hover:shadow-xl transition-shadow duration-300">
                                ...
                                <CardContent className="space-y-6">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            "iPhone 13 not as described - screen
                                            has scratches"
                                        </p>
                                    </div>
                                    <div className="space-y-3">
                                    ...
                                    <div className="text-xs text-muted-foreground">
                                        Reward: 50 CRAILO tokens + 0.1% protocol
                                        fee
                                    </div>
                                </CardContent>
                            </Card>
