...
const ListingDetailsModal: React.FC<ListingDetailsModalProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="w-[80vw] max-w-[80vw] max-h-[90vh] overflow-y-auto bg-white dark:bg-zinc-900 border border-green-200 dark:border-green-800 rounded-lg shadow-xl">
        ...
        <div className="flex flex-col overflow-y-auto">
          {/* Escrow Protection Banner - Moved to top */}
          <div className="px-6 pb-4">
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 p-4 rounded-lg border border-green-200 dark:border-green-800">
              ...
              <p className="text-sm text-green-600 dark:text-green-400">
                ...
                confirm receipt of the item. This protects both buyers and
                sellers from fraud.
              </p>
            </div>
          </div>

          <div className="flex flex-col lg:flex-row gap-6 px-6 pb-6 overflow-hidden flex-1">
            {/* Left side - Image Carousel */}
            <div className="lg:w-1/2 max-h-[500px] lg:max-h-[600px] rounded-lg overflow-hidden border border-green-200 dark:border-green-800 bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
              <Carousel
            ...
            {/* Right side - Details */}
            <div className="lg:w-1/2 overflow-y-auto pr-2 custom-scrollbar space-y-6">
              {/* Description */}
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Badge variant="outline" className="text-sm font-mono">
                      ${listing.escrowAmount.toFixed(2)}
                    </Badge>
                  </div>
                  <div className="flex justify-between items-center pt-2 border-t border-green-200 dark:border-green-800">
                    ...
                    <Badge className="text-lg bg-green-600 hover:bg-green-700 font-mono">
                      ${(listing.price + listing.escrowAmount).toFixed(2)}
                    </Badge>
                  </div>
                </div>
              </div>
