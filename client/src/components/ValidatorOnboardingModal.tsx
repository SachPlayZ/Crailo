                            ...
                            <div className="space-y-8">
                                <div className="flex flex-col items-center justify-center space-y-4">
                                    ...
                                    <p className="text-muted-foreground text-center text-sm max-w-md">
                                        By becoming a Crailo validator, you
                                        agree to act fairly, review evidence
                                        honestly, and maintain confidentiality.
                                        You understand that your stake may be at
                                        risk if you violate the code of conduct.
                                    </p>
                                </div>
